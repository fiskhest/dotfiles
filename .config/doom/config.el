...
(setq user-full-name "Johan Radivoj"
      user-mail-address "johan.radivoj@relexsolutions.com"
...
;;;;; mail
(set-email-account! "relexsolutions.com"
                    '((mu4e-sent-folder       . "/relexsolutions.com/Sent Mail")
                      (mu4e-drafts-folder     . "/relexsolutions.com/Drafts")
                      (mu4e-trash-folder      . "/relexsolutions.com/Trash")
                      (mu4e-refile-folder     . "/relexsolutions.com/All Mail")
                      (smtpmail-smtp-user     . "johan.radivoj@relexsolutions.com"))
                    t)
